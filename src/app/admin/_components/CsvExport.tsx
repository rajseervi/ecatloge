      ...
      <div className="px-5 py-4 space-y-3">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-semibold text-gray-900">Export Active Products Only</p>
              <p className="text-xs text-gray-500">{totalActive} visible products</p>
            </div>
          </div>
          <span className="text-xs font-medium text-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity">
            Download
        ...
        >
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-amber-50 group-hover:bg-white transition-colors">
              <svg className="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
            </div>
            <div className="text-left">
              <p className="text-sm font-semibold text-gray-900">Export Low Stock Report</p>
              <p className="text-xs text-gray-500">{totalLowStock} items need attention</p>
            </div>
          </div>
          <span className="text-xs font-medium text-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity">
            Download
